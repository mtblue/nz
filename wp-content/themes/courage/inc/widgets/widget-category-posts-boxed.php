...
class Courage_Category_Posts_Boxed_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$this->WP_Widget('courage_category_posts_boxed', __('Category Posts Boxed (Courage)', 'courage'), $widget_ops);
