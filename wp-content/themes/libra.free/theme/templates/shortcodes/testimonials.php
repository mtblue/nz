    ...
    if( !$tests->have_posts() ) return false ?>    		
			...
			<?php while( $tests->have_posts() ) : $tests->the_post();
                ...
                <div class="testimonial-square-style span<?php echo $cols ?>">
                    <?php if (yit_get_option('thumbnail-testimonials') && get_the_post_thumbnail( null, 'thumb-testimonial-square' )) :  ?>
                        <div class="thumbnail">
                            <?php echo get_the_post_thumbnail( null, 'thumb-testimonial-square' ); ?>   
                        </div>
                    <?php 
                        else:
                            $fulltext = '-full';					
