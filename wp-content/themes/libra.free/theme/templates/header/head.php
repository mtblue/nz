...
// clickout
wp_enqueue_script( 'jquery-clickout', get_template_directory_uri() .'/theme/assets/js/jquery.clickout.min.js', array('jquery'), '', true);
...
// Images Loaded
wp_register_script( 'jquery-imagesLoaded', YIT_THEME_JS_URL . '/jquery.imagesLoaded.js' );
