...
if( !function_exists( 'yit_add_custom_styles' ) ) {
    function yit_add_custom_styles() {        
        ...
        if( file_exists( yit_get_model('cache')->locate_file( $cache_file ) ) )
...
/* === BLOG */
if( !function_exists( 'yit_related_posts' ) ) {
    function yit_related_posts() {
        yit_get_template( '/blog/related.php' );
    }
}
...
if( !function_exists( 'yit_loop_blog_libra_big' ) ) {
    function yit_loop_blog_libra_big() {
        yit_get_template( '/blog/libra-big/markup.php' );
    }
}

if( !function_exists( 'yit_loop_blog_libra_small' ) ) {
    function yit_loop_blog_libra_small() {
        yit_get_template( '/blog/libra-small/markup.php' );
    }
}
                            ...
                            <div class="row">
                                ...
                                <div class="comment-meta commentmetadata reply comment-author-name comment-date span2">
                                    ...
                                    comment_reply_link( array_merge( $args, array(
                                        ...
                                        'before' => apply_filters( 'yit_comment_reply_link_before', '<img class="comment-reply-link" src="' . YIT_THEME_IMG_URL . '/icons/comment-reply-link.png" title="' . __( 'reply', 'yit' ) . '" alt="+" />' )
                                    ) ) ); ?>
                                </div><!-- .reply -->
                            </div>
