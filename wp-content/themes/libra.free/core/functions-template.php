...
if( !function_exists( 'yit_get_meta_tags' ) ) {
    ...
    function yit_get_meta_tags() {
        ...
        if( $post_id ) {
            ...
            $keywords    = !empty( $post_type )    ? yit_get_post_meta( $post_id, $post_type . '-seo-keywords' )    : '';
            $description = !empty( $post_type ) ? yit_get_post_meta( $post_id, $post_type . '-seo-description' ) : '';  
...
if( !function_exists( 'yit_get_title' ) ) {
    ...
    function yit_get_title() {
        ...
        if( $post_id ) {
            ...
            if( !empty( $post_type ) )
                { $title = yit_get_post_meta( $post_id, $post_type . '-seo-title' ); }    
