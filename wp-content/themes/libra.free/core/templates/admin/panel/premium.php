<?php 
$landing = 'http://yithemes.com/themes/wordpress/libra-corporate-portfolio-wp-theme/?utm_source=yith-panel&utm_medium=wpadmin&utm_content=tab-premium-libra&utm_campaign=yith-admin';
$live = 'http://demo.yithemes.com/libra/';

$domain = 'http://yithemes.com';
$base_url = $domain . '/wp-content/themes/yithemes';

$name = 'Libra Corporate & Portfolio WP theme';
$price = '49';
if ( false === ( $price = get_transient( 'yit_theme_price_' . get_template() ) ) ) {
    $requrl = 'http://yithemes.com/?wc-api=yit_theme_price&theme=libra';
...
<div class="container bolder-tpl landing">
    <img src="<?php echo $base_url ?>/landings/images/logo/libra.jpg" class="logo" alt="<?php echo $name ?>" />
    <!-- END LOGO -->
    ...
    <ul class="actions">
    <li><a href="<?php echo $landing ?>" target="_blank"><img src="<?php echo get_template_directory_uri() ?>/core/assets/images/premium/buy-now.jpg" alt="Buy Now"></a></li>
    <li><a href="<?php echo $live ?>" target="_blank"><img src="<?php echo get_template_directory_uri() ?>/core/assets/images/premium/live-preview.jpg" alt="Live Preview"></a></li>
    </ul>
    ...
    <ul class="premium-features">
        ...
        <li>
            <img src="<?php echo $base_url ?>/landings/images/features/forum.jpg" alt="<?php echo $name ?>" />
        ...
        <li>
            <img src="<?php echo $base_url ?>/landings/images/features/videotutorials.jpg" alt="<?php echo $name ?>" />
        ...
        <li>
            <img src="<?php echo $base_url ?>/landings/images/features/import_settings.jpg" alt="<?php echo $name ?>" />
        ...
        <li>
            <img src="<?php echo $base_url ?>/landings/images/features/themeoptions-pinkrio.jpg" alt="<?php echo $name ?>" />
        ...
        <li>
            <img src="<?php echo $base_url ?>/landings/images/features/slider-pinkrio.jpg" alt="<?php echo $name ?>" />
        ...
        <li>
            <img src="<?php echo $base_url ?>/landings/images/features/unlimited_colors.jpg" alt="<?php echo $name ?>" />
        ...
        <li>
            <img src="<?php echo $base_url ?>/landings/images/features/cufon.jpg" alt="<?php echo $name ?>" />
        ...
        <li>
            <img src="<?php echo $base_url ?>/landings/images/features/contact-pinkrio.jpg" alt="<?php echo $name ?>" />
        ...
        <li>
            <img src="<?php echo $base_url ?>/landings/images/features/memento-portfolio.jpg" alt="<?php echo $name ?>" />

            <h3>4 portfolio layouts</h3>
        ...
        <li>
            <img src="<?php echo $base_url ?>/landings/images/features/video-pinkrio.jpg" alt="<?php echo $name ?>" />
        ...
        <li>
            <img src="<?php echo $base_url ?>/landings/images/features/customwidget.jpg" alt="<?php echo $name ?>" />
        ...
        <li>
            <img src="<?php echo $base_url ?>/landings/images/features/shortcodes-pinkrio.jpg" alt="<?php echo $name ?>" />
