...
jQuery(document).ready(function(){
	...
	if(jQuery('#section-thinkup_header_styleswitch input[value=option2]').is(":checked")){
		jQuery('#section-thinkup_header_locationswitch').show();
	}
	else if(jQuery('#section-thinkup_header_styleswitch input[value=option2]').not(":checked")){
