	...
	if ( $thinkup_header_socialswitchpre == '1' ) {
		...
		foreach( $social_links as $social ) {	
			...
			echo '<li class="social ' . esc_attr( $social['icon'] ) . '">',
				 '<a href="' . esc_url( $social['link'] ) . '" data-tip="bottom" data-original-title="' . esc_attr( $social['social'] ) . '">',
...
$output = NULL;
	...
	if ( $thinkup_header_socialswitchmain == '1' ) {
		...
		foreach( $social_links as $social ) {	
			...
			$output .= '<a href="' . esc_url( $social['link'] ) . '" data-tip="bottom" data-original-title="' . esc_attr( $social['social'] ) . '">';
