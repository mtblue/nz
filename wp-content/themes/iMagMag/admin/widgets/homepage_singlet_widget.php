...
add_action('widgets_init', 'tpcrn_magazine_singlethumb_widgets');
function tpcrn_magazine_singlethumb_widgets(){
 register_widget('tpcrn_magazine_singlethumb_Widget');
 }
...
class tpcrn_magazine_singlethumb_Widget extends WP_Widget {
	function tpcrn_magazine_singlethumb_Widget()
	{
		$widget_ops = array('classname' => 'tpcrn_magazine_singlethumb', 'description' => 'Show Magazine blog Posts.(For Homapage only)');
		$control_ops = array('id_base' => 'tpcrn_magazine_singlethumb-widget');
		$this->WP_Widget('tpcrn_magazine_singlethumb-widget', 'ThemePacific: Magazine Blog', $widget_ops, $control_ops);
 	}
/**
* Display the widget
*/	
 		...
 		<li class="full-left clearfix">
			...
			<span class="meta_date"><?php _e('On', 'themepacific'); ?> <?php the_time('F d, Y'); ?></span>
 			<span class="meta_comments"><?php _e('', 'themepacific'); ?>  <a href="<?php comments_link(); ?>"><?php comments_number('0 Comment', '1 Comment', '% Comments'); ?></a></span>
					...
					<?php tpcrn_excerpt('tpcrn_home_mag'); ?>
					</div>
				</div>
         </li> 
 				<?php else: ?>
