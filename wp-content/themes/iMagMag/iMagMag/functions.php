...
function tpcrn_pagination() {
  ...
  /*-- Custom Excerpts--*/
function tpcrn_home_center($length) {   
	    return 50;
	}
function tpcrn_home_mag($length) {   
	    return 34;
	}
function tpcrn_home_left($length) {  
	    return 63;
	}
function tpcrn_home_slider($length) {  
	    return 15;
	}
function tpcrn_maga_menu($length) {  
	    return 22;
	}
	
 
/*--- Create the Custom Excerpts callback---*/
function tpcrn_excerpt($length_callback='', $more_callback='') {
	    global $post;
...
function tpcrn_cre_def( )
{
		...
		echo '<div class="foot-wrap container">';
 		echo '<p class="copyright">'.get_bloginfo('name'). '&nbsp; &copy;&nbsp;' . $b_dat.  '</p>';
   		echo '<p class="credit">Designed by <a title="Coco Mag By SpicyTricks" href="http://www.spicytricks.com">SpicyTricks</a></p>';
		echo '</div>';
